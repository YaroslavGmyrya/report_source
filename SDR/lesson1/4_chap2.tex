...
\subsection{ADC / DAC}
ADC (Analog-to-Digital Conversion): оцифровка аналогового сигнала. Получение отсчетов сигнала.
...
\subsection{libiio}
Библиотека, которая облегчает работу с устройствами ввода/вывода в \textbf{Linux}. Она даёт \textbf{API} для обмена данными и 
управления устройствами.

\subsection{Linux Kernel (ядро Linux)}
...
\subsection{Xilinx Zynq}
  Семейство микросхем от компании Xilinx. На одном кристалле 
...
и запускать программы непосредственно с использованием SDR-модулей. \\
...
\section{Построение схемы в GNU Radio}

\subsection{Блок options}
...
\subsection{QT GUI Frequency Sink}
