...
\section{Передача данных между Adalm Pluto и хостом}
...
\section{Установка необходимых библиотек и зависимостей}
...
\section{Основне моменты работы с Adalm Pluto напрямую из C++}
...
\subsection{Формирование потоков и буферов}
...
\subsection{Получение I/Q семплов}
...
Можем заметить, что графики напонимают прямоугольный сигнал.
